...
function restStatusHandler(className) {
  ...
  function create(object) {
    lastPromise = lastPromise.then(function () {
      return _node2.default._request('POST', 'classes/' + className, object, { useMasterKey: true }).then(function (result) {
        // merge the objects
        var response = Object.assign({}, object, result);
  ...
  function update(where, object) {
    ...
    lastPromise = lastPromise.then(function () {
      return _node2.default._request('PUT', 'classes/' + className + '/' + where.objectId, object, { useMasterKey: true }).then(function (result) {
        // merge the objects
        var response = Object.assign({}, object, result);
        return Promise.resolve(response);
      });
...
function pushStatusHandler(config, existingObjectId) {
  ...
  var database = config.database;
  var handler = restStatusHandler(PUSH_STATUS_COLLECTION);
